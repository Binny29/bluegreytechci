...
class Login_model extends CI_Model
 {
  ...
  function getinquery(){
    //echo"ghgh";die;
    $this->db->select("*");
    $this->db->from("tblinquery as inq");
    $this->db->join("tblcountry as cn",'cn.CountryId=inq.CountryId','left');
    $this->db->join("tblintrestedtype as inttyp",'inttyp.IntrestedTypeId=inq.IntrestedTypeId','left');
 ...
 function getinquerydata($id){
    ...
    $this->db->where("inq.InquiryId",$id);
    $query=$this->db->get();
   // echo $this->db->last_query(); die;
