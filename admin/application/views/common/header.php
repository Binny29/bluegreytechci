...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>default/favicon/favicon.ico">
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url(); ?>default/favicon/favicon-32.png">
                                    ...
                                    <div class="navbar-wrapper">
                                      <div class="navbar-header">
                                        <ul class="nav navbar-nav">
                                          ...
                                          <li class="nav-item"><a class="navbar-brand nav-link"><img alt="branding logo" src="<?php echo base_url(); ?>default/images/logo/logo-light.png" data-expand="<?php echo base_url(); ?>default/images/logo/logo-light.png" data-collapse="<?php echo base_url(); ?>default/images/logo/logo-light.png" class="brand-logo"></a></li>
