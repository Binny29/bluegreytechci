                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $row->IntrestedType; ?></td>

                                    <td><?php $rr=$row->DescriptionMessage;
                                                   echo substr("$rr",0,30).'...';?></td>
                                  
                                    <td>
                                        <?php echo anchor('home/viewinquery/'.$row->InquiryId,'<i class="ficon icon-eye"></i>'); ?>
                                        <a href="javascript:void(0)"  onclick="deletedata('<?php echo $row->InquiryId; ?>')" ><i class="ficon icon-bin"></i></a>    
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
